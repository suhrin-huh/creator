...
export default function ProfileSection() {
  ...
  return (
    <section className="gap-lg p-2xl flex flex-col items-center rounded-2xl bg-white shadow-md">
      ...
      <div className="gap-y-md flex flex-col items-center text-center">
        <p className="text-primary-dark text-h3 font-bold">허서린</p>
        <p className="text-body-sm text-gray-600">📧 suhrinhuh77@gmail.com</p>
        ...
        <div className="gap-md flex flex-wrap justify-center">
          {snsOptions.map((option, idx) => (
            <a
              ...
              href={option.href}
              className="gap-x-sm px-lg py-md bg-primary text-caption hover:bg-primary-hover flex items-center rounded-full font-semibold text-white shadow-md transition duration-100 active:scale-105"
            >
              {option.icon}
